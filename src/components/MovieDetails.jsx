    ...
    >
      ...
      <div className="w-full sm:flex sm:flex-row flex-col">
        {/* <div className="w-full ">
          <img
            className="shadow-[8px_17px_38px_2px_rgba(0,0,0,.5)] h-[55vh] object-center rounded-sm"
            src={`https://image.tmdb.org/t/p/original/${info.detail.poster_path || info.detail.backdrop_path}`}
            alt=""
          />
          <div className="w-[0%] bg-red-100 flex flex-col gap-y-5 my-5">
      ...
      {/* part-4 recommendations ansd similar part */}
